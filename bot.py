...
boss = ['Freebootcar']#usuarios supremos

Configs = {"uclv":'',"gtm":"","uvs":"","ltu":"","uccfd":"","vcl":"",
			"ucuser": "", "ucpass":"","uclv_p":"", "gp":None, "s":"On", 
			'Freebootcar': {'z': 99,"m":"e","a":"c","t":"y","gp":False}}
...
total_up = {'Freebootcar':{'P':0,'S':0}} #total en gb o megas subidos en bytes (int)
rvs = {'Freebootcar':{'h':'','u':'','p':'','up':'','z':0,'m':'m'}}
...
async def nube(client: Client, message: Message):
	...
	Configs[username]["z"] = 99
	await send_config()
	await send("☁️ Nextcloud Activada ☁️")
